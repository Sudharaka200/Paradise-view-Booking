<!-- js  -->
    <?php include '../library/script.js' ?>
<!-- js  -->


<!-- footer -->
 <!-- Footer -->
<footer class="text-center text-lg-start font-second-p" style="color: #fff; background-color: #7C6A46;">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <!-- Content -->
          <h6 class="text-uppercase fw-bold mb-4 italic-font">
            Paradise View
          </h6>
          <p>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Room booking</a>
          </p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2024 Copyright:
    <a class="text-reset fw-bold" href="www.linkedin.com/in/sudharaka-pathiraja-10646820b">Sudharaka Pathiraja</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
